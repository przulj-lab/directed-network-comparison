...
- **[C++ Directed Graphlet Counter](link)** - Efficient computation of directed graphlet degree vector (DGDV) signatures
- **[Python Network Comparison Script](link)** - Computing distances between directed networks
